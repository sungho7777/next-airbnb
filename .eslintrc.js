module.exports = {
    ...
    "rules": {
        "quotes":["error", "double"],
        "@typescrtip-eslint/quotes" : ["error", "double"], // 더블 쿼터 사용
        ...
        "react/no-array-index-key": "off",  // key 값으로 index를 사용할 수 없다.
        "comma-dangle": "off",              // 마지막에 , 을 넣어주지 않느다.
        "arrow-body-style": "off",          // 화살표 함수 안에 return을 사용할 수 있다.
        "react/no-unescaped-entities":"off",    // 문자열 내에서 " ' ? } 허용
        "react/prop-types": "off",              // propertys를 사용하지 않는다.
        ...
        "jsx-ally/anchor-is-valid": "off",      // next.js 에서는 a에 herf없이 사용
        ...
        "no-case-declarations": "off",          // case 문 안에서 변수 선언 사용하기
